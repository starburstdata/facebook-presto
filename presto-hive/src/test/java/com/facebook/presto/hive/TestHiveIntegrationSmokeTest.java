        ...
        try {
            ...
            assertUpdate(
                    Session.builder(getSession())
                            ...
                            .build(),
                    "CREATE TABLE scale_writers_large WITH (format = 'RCBINARY') AS SELECT * FROM tpch.sf20.orders",
                    (long) computeActual("SELECT count(*) FROM tpch.sf20.orders").getOnlyValue());
