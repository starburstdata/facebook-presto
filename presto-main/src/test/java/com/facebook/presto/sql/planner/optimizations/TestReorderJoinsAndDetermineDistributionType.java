        ...
        extends BasePlanTest
{
    ...
    public String tpchQuery(int queryNumber)
    {
        try {
            String queryPath = String.format("/io/airlift/tpch/queries/q%d.sql", queryNumber);
            URL resourceUrl = Customer.class.getResource(queryPath);
