...
import com.facebook.presto.sql.planner.iterative.rule.PlanEnumeration.Result;
...
public class TestJoinEnumerator
{
    ...
    public void testDoesNotCreateJoinWhenPartitionedOnCrossJoin()
    {
        ...
        Result actual = joinEnumerator.createJoinAccordingToPartitioning(multiJoinNode.getSources(), multiJoinNode.getOutputSymbols(), ImmutableSet.of(0));
