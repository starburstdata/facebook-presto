        ...
        extends BaseStatsCalculatorTest
{
    ...
    private static final JoinStatsRule JOIN_STATS_RULE = new JoinStatsRule(new FilterStatsCalculator(createTestMetadataManager(), NORMALIZER), NORMALIZER, 1.0);
    ...
    public void testAddJoinComplementStats()
    {
        ...
        PlanNodeStatsEstimate statsToAdd = planNodeStats(RIGHT_ROWS_COUNT,
                symbolStatistics(LEFT_JOIN_COLUMN, -5.0, 5.0, 0.2, statsToAddNdv));

        PlanNodeStatsEstimate addedStats = planNodeStats(TOTAL_ROWS_COUNT,
                symbolStatistics(LEFT_JOIN_COLUMN, -5.0, 20.0, (LEFT_ROWS_COUNT * LEFT_JOIN_COLUMN_NULLS + RIGHT_ROWS_COUNT * 0.2) / TOTAL_ROWS_COUNT, LEFT_JOIN_COLUMN_NDV + statsToAddNdv),
        ...
        assertThat(JOIN_STATS_RULE.addJoinComplementStats(
                LEFT_STATS /* cross stats */,
                LEFT_STATS,
                new JoinComplementStats(statsToAdd, Optional.of(new Symbol(LEFT_JOIN_COLUMN))),
                LEFT_JOIN_COLUMN_NDV + statsToAddNdv))
                .equalTo(addedStats);
    }
