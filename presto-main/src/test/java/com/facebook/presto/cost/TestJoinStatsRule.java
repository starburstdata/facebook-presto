    ...
    extends BaseStatsCalculatorTest
{
    ...
    public void testAddJoinComplementStats()
    {
        ...
        assertThat(JOIN_STATS_RULE.addJoinComplementStats(LEFT_STATS, new JoinComplementStats(statsToAdd, Optional.of(new Symbol(LEFT_JOIN_COLUMN))), LEFT_JOIN_COLUMN_NDV + statsToAddNdv)).equalTo(addedStats);
    }
