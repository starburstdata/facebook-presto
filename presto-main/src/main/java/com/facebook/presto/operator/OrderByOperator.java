        ...
        implements Operator
{
    ...
    private WorkProcessor<Page> mergeSpilledAndMemoryPages(List<WorkProcessor<Page>> spilledPages, Iterator<Page> sortedPagesIndex)
    {
        ...
        // TODO mergeSortedPages() must make progress even if yield signal is set upon entry. Currently, if yield is immediate, no progress would be made, operator would loop idly
