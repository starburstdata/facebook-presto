...
import static com.facebook.presto.sql.planner.optimizations.StreamPreferredProperties.hybridParallelism;
...
public class AddLocalExchangeBelowPartialAggregation
        implements Rule<AggregationNode>
{
    ...
    public AddLocalExchangeBelowPartialAggregation(Metadata metadata, SqlParser parser)
    {
    ...
    public Result apply(AggregationNode node, Captures captures, Context context)
    {
        ...
        StreamPreferredProperties requiredProperties = hybridParallelism().withPartitioning(node.getGroupingKeys());
                ...
                node.replaceChildren(ImmutableList.of(
                        partitionedExchange(
                                ...
                                new PartitioningScheme(
                                        Partitioning.create(HYBRID_HASH_PASSTHROUGH_DISTRIBUTION, node.getGroupingKeys()),
