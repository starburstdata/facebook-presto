        ...
        implements PlanOptimizer
{
    ...
    private Rule.Context ruleContext(Context context)
    {
        ...
        //StatsProvider upperEstimateStatsProvider = new CachingStatsProvider(statsCalculators.getUpperEstimateStatsCalculator(), Optional.empty(), context.lookup, context.session, context.symbolAllocator.getTypes());
