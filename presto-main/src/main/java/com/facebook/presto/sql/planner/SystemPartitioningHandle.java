        ...
        implements ConnectorPartitioningHandle
{
    ...
    public static final PartitioningHandle ADAPTIVE_HASH_PASSTHROUGH_DISTRIBUTION = createSystemPartitioning(SystemPartitioning.ADAPTIVE, SystemPartitionFunction.HASH);
