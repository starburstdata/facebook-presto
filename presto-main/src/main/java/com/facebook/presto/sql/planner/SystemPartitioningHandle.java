        ...
        implements ConnectorPartitioningHandle
{
    ...
    public static final PartitioningHandle HYBRID_HASH_PASSTHROUGH_DISTRIBUTION = createSystemPartitioning(SystemPartitioning.HYBRID, SystemPartitionFunction.HASH);
