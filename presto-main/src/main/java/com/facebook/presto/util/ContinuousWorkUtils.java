...
public final class ContinuousWorkUtils
{
    ...
    public static <T> ContinuousWork<T> mergeSorted(Iterable<ContinuousWork<T>> workIterable, Comparator<T> comparator)
    {
    ...
    public static <T, R> ContinuousWork<R> flatMap(ContinuousWork<T> work, Function<T, Iterator<R>> mapper)
    {
    ...
    public static <T, R> ContinuousWork<R> map(ContinuousWork<T> work, Function<T, R> mapper)
    {
    ...
    public static <T, R> ContinuousWork<R> transform(ContinuousWork<T> work, Function<Optional<T>, WorkState<R>> transformation)
    {
    ...
    public static <T> ContinuousWork<T> create(Supplier<WorkState<T>> supplier)
    {
    ...
    public static final class WorkState<T>
    {
        ...
        {
            return new WorkState<>(Type.NEEDS_MORE_DATA, true, Optional.empty(), Optional.empty());
        }
        ...
        {
            return new WorkState<>(Type.YIELD, false, Optional.empty(), Optional.empty());
        }
        ...
        {
            return new WorkState<>(Type.FINISHED, false, Optional.empty(), Optional.empty());
        }
    }
