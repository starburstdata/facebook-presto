...
public class StatementResource
{
            ...
            @Context UriInfo uriInfo)
    {
        ...
        SessionContext sessionContext = new HttpRequestSessionContext(servletRequest, querySubmission.getPreparedStatements());
        ...
        return toResponse(query, queryResults, servletRequest);
    }
            ...
            @Context HttpServletRequest servletRequest)
    {
        ...
        asyncQueryResults(query, OptionalLong.of(token), maxWait, uriInfo, proto, asyncResponse, servletRequest);
    }

    private void asyncQueryResults(Query query, OptionalLong token, Duration maxWait, UriInfo uriInfo, String scheme, AsyncResponse asyncResponse, HttpServletRequest servletRequest)
    {
