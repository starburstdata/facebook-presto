        ...
        extends AbstractConfigurationAwareModule
{
    ...
    @Singleton
    @New
    public static StatsCalculator createNewStatsCalculator(Metadata metadata, ScalarStatsCalculator scalarStatsCalculator, SemiJoinStatsCalculator semiJoinStatsCalculator)
    {
        FilterStatsCalculator filterStatsCalculator = new FilterStatsCalculator(metadata);
